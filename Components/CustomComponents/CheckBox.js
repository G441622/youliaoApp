...
export default class CheckBox extends Component {
    ...
    genCheckedImage() {
        var source;
        if (this.props.isIndeterminate) {
            source = require('./assets/img/ic_indeterminate_check_box.png');
        }
        else {
            source = this.props.isChecked ? require('./assets/img/ic_check_box.png') : require('./assets/img/ic_check_box_outline_blank.png');
        }
