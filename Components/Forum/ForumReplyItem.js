...
class ForumReplyItem extends Component {
    constructor(props){
        super(props)
        this.state = {
            likecount:0
    ...
    getComment = ()=>{
        let {comment,index,forum_id} = this.props
        ...
        return {...comment,islike,likecount,forum_id};
    }
    render(){
        let {comment,index} = this.props
...
export default connect(mapStateToProps,mapDispatchToProps)(ForumReplyItem)
